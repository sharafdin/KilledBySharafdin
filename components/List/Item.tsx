...
export default function Item(props: ProductWithSlug) {
  ...
  const getIcon = () => {
    return isPast() ? (
      <Icon
        src="https://raw.githubusercontent.com/sharafdin/KilledBySharafdin/3dbe047be82bf047d1c56a53d3ffe1293859d6b4/assets/tombstone.svg"
        alt="Tombstone"
      />
    ) : (
      <Icon
        src="https://raw.githubusercontent.com/sharafdin/KilledBySharafdin/3dbe047be82bf047d1c56a53d3ffe1293859d6b4/assets/guillotine.svg"
        alt="Guillotine"
      />
    );
  };
